    ...
    const schools = [
      ...
      },
      {
        ...
        data: {
          ...
          ranking: "#4 in Taiwan · Top 10 Asia for EE/CS",
          hasDorm: true,
          isApproved: true,
      ...
      },
      {
        ...
        data: {
          ...
          ranking: "Top Private University · Most Beautiful Campus",
          hasDorm: true,
          isApproved: true,
